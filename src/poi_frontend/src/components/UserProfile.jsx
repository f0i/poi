    ...
    <div className="space-y-6">
      ...
      {userDataLoading ? (
          ...
          <div className="space-y-3">
            {userData.name && userData.name.length > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-slate-700">
                ...
                <span className="text-white font-medium">{userData.name[0]}</span>
              </div>
            )}
            ...
            {userData.username && userData.username.length > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-slate-700">
                ...
                <span className="text-white font-medium">@{userData.username[0]}</span>
              </div>
            )}
            ...
            {userData.email && userData.email.length > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-slate-700">
                ...
                <span className="text-white font-medium">{userData.email[0]}</span>
              </div>
            )}
            ...
            {userData.location && userData.location.length > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-slate-700">
                ...
                <span className="text-white font-medium">{userData.location[0]}</span>
              </div>
            )}
        ...
        <div className="card text-center">
          ...
          <p className="text-slate-400 text-sm">Unable to load your profile information</p>
        </div>
      )}
    </div>
  );
