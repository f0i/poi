      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-slate-400">Complete challenges to earn points!</p>
            <p className="text-slate-500 text-sm">Check the Challenges tab to get started.</p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-slate-500 text-sm">See how you rank against other users.</p>
          </div>
        </div>
      </div>
